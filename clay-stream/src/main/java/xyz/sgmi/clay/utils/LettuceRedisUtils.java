...
import xyz.sgmi.clay.callback.RedisPipelineCallBack;
...
public class LettuceRedisUtils {
    ...
    static {
        RedisURI redisUri = RedisURI.Builder.redis(ClayFlinkConstant.REDIS_IP)
                .withPort(Integer.valueOf(ClayFlinkConstant.REDIS_PORT))
                .withPassword(ClayFlinkConstant.REDIS_PASSWORD.toCharArray())
                .build();
