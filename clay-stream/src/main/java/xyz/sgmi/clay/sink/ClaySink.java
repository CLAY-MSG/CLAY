...
import xyz.sgmi.clay.domain.SimpleAnchorInfo;
import xyz.sgmi.clay.utils.LettuceRedisUtils;
 ...
 */
@Slf4j
public class ClaySink implements SinkFunction<AnchorInfo> {
